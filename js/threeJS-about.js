...
const material = new THREE.MeshStandardMaterial({ map: loader.load('../public/static/images/moonmap4k.jpg')});
...
//for every 1000 places in the array, add a star in a random position
...
function animate() {
  ...
  moonGroup.position.x = radius * Math.cos(angle);
  moonGroup.position.z = radius * Math.sin(angle);
